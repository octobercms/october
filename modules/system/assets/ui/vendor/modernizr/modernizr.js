...
! function(e, t, n) {
    ...
    function v(e, t, a, o) {
        ...
        for (var u, f, p, m, g, v = ["modernizr", "tspan", "samp"]; !G.style && v.length;) u = !0, G.modElem = i(v.shift()), G.style = G.modElem.style;
        for (p = e.length, f = 0; p > f; f++)
            if (m = e[f], g = G.style[m], s(m, "-") && (m = d(m)), G.style[m] !== n) {
                if (o || r(a, "undefined")) return c(), "pfx" == t ? m : !0;
                try {
                    G.style[m] = a
                } catch (y) {}
                if (G.style[m] != g) return c(), "pfx" == t ? m : !0
            } return c(), !1
    }
    ...
    Modernizr.input = function(t) {
        for (var n = 0, r = t.length; r > n; n++) M[t[n]] = !!(t[n] in R);
    ...
    var Z = S.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? W(e) : (-1 != e.indexOf("-") && (e = d(e)), t ? y(e, t, n) : y(e, "pfx"))
    };
