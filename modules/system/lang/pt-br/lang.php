...
return [
    ...
    'plugin' => [
        ...
        'name' => [
            ...
            'help' => 'Nomeie o plugin pelo seu código único. Por exemplo, RainLab.Blog',
        ]
    ],
    'plugins' => [
    ...
    'mail' => [
        ...
        'ses' => 'SES',
        'ses_key' => 'Chave SES',
        'ses_key_comment' => 'Digite sua chave da API SES',
        'ses_secret' => 'Segredo SES',
        'ses_secret_comment' => 'Digite sua chave secreta da API SES',
        'ses_region' => 'Região SES',
        'ses_region_comment' => 'Digite sua região SES (por exemplo, us-east-1)',
    ...
    'mail_templates' => [
        ...
        'test_confirm' => 'Enviar mensagem de teste para :email. Continuar?',
        'creating' => 'Criando Modelo...',
        'creating_layout' => 'Criando Layout...',
        'saving' => 'Salvando Modelo...',
        'saving_layout' => 'Salvando Layout...',
        'delete_confirm' => 'Apagar esse modelo?',
        'delete_layout_confirm' => 'Apagar esse layout?',
        'deleting' => 'Apagando Modelo...',
        'deleting_layout' => 'Apagando Layout...',
    ...
    'permissions' => [
        ...
        'manage_preferences' => 'Gerenciar preferências da Administração',
