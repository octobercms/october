...
return [
    ...
    'plugins' => [
        ...
        'bulk_actions_label' => 'Działania masowe',
        'check_yes' => 'Tak',
        'check_no' => 'Nie',
    ...
    'mail_templates' => [
        ...
        'options' => 'Opcje',
        'disable_auto_inline_css' => 'Wyłącz automatyczny Inline CSS'
    ],
    'mail_brand' => [
    ...
    'updates' => [
        ...
        'core_set_build' => 'Ustaw numer kompilacji',
        'changelog' => 'Lista zmian',
        'changelog_view_details' => 'Zobacz szczegóły',
        'plugins' => 'Wtyczki',
        'themes' => 'Motywy',
        'disabled' => 'Wyłączony',
        ...
        'important_view_release_notes' => 'Wyświetl informacje o wersji',
        ...
        'details_changelog' => 'Lista zmian',
        'details_changelog_missing' => 'Nie dostarczono listy zmian.',
        'details_upgrades' => 'Podręcznik Aktualizacji',
        'details_upgrades_missing' => 'Nie dostarczono instrukcji aktualizacji.',
        'details_licence' => 'Licencja',
        'details_licence_missing' => 'Nie dostarczono licencji/',
    ...
    'permissions' => [
        ...
        'impersonate_users' => 'Podszywaj się pod użytkowników',
        ...
        'manage_default_dashboard' => 'Zarządzaj domyślnym kokpitem',
    ...
    'log' => [
        ...
        'log_requests_comment' => 'Żądania przeglądarek, które mogą wymagać uwagi (na z odpowiedzią 404 Nie znaleziono)',
    ...
    'page' => [
        'custom_error' => [
            'label' => 'Błąd strony',
            'help' => 'Przepraszamy, ale coś poszło nie tak i stronia nie może zostać wyświetlona.'
        ],
        'maintenance' => [
            'label' => 'Wracamy za chwilę!',
            'help' => 'Aktualnie mamy przerwę techniczną. Sprawdź ponownie za chwilę!',
            'message' => 'Wiadomość:',
            'available_at' => 'Spróbuj ponownie za:'
        ]
    ],
    'pagination' => [
        'previous' => 'Poprzedni',
