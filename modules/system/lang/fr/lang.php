...
return [
    ...
    'mail_templates' => [
        ...
        'creating' => 'Création du modèle en cours…',
        'creating_layout' => 'Création de la maquette en cours…',
        'saving' => 'Sauvegarde du modèle en cours…',
        'saving_layout' => 'Sauvegarde de la maquette en cours…',
        'delete_confirm' => 'Confirmer la suppression de ce modèle ?',
        'delete_layout_confirm' => 'Confirmer la suppression de cette maquette ?',
        'deleting' => 'Suppression du modèle en cours…',
        'deleting_layout' => 'Suppression de la maquette en cours…',
    ...
    'permissions' => [
        ...
        'manage_editor' => 'Gérer les préférences pour l’éditeur',
