...
return [
    ...
    'updates' => [
        ...
        'found' => [
            ...
            'help' => 'Виберіть «Оновити», щоб почати процес оновлення.',
        ],
        'none' => [
        ...
        'details_licence_missing' => 'Ліцензія не передбачено.',
    ...
    'request_log' => [
        'hint' => 'У цьому журналі відображається список запитів браузера, які можуть зажадати уваги. Наприклад, якщо відвідувач відкриває неіснуючу сторінку, то в журналі створюється запис з кодом статусу 404.',
    ...
    'log' => [
        ...
        'menu_description' => 'Вкажіть, які налаштування слід використовувати для протоколювання.',
        'default_tab' => 'Вхід',
        ...
        'log_requests_comment' => 'Запити браузерів, які можуть зажадати уваги, такі як помилка 404.',
