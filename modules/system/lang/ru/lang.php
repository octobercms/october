...
return [
    ...
    'log' => [
        'menu_label' => 'Настройки журнала',
        'menu_description' => 'Укажите, какие области следует использовать для ведения журнала.',
        'default_tab' => 'Логирование',
        'log_events' => 'События системы регистрации',
        'log_events_comment' => 'Храните системные события в базе данных в дополнение к файловому журналу.',
        'log_requests' => 'Зарегистрировать неудачные запросы',
        'log_requests_comment' => 'Запросы браузера, которые могут потребовать внимания, например 404 ошибки.',
        'log_theme' => 'Изменение темы журнала',
        'log_theme_comment' => 'Когда изменение происходит с темой, используя фоновый код.',
    ]
];
