...
return [
    ...
    'updates'        => [
        ...
        'dependencies_description'     => 'Обнаружены проблемы требующие вашего внимания',
        'dependencies_plugin_missing'  => 'Плагин :code ялвяется зависисмостью плагина :parent_code, но он не обнаружен в системе. Пожалуйста установите этот плагин.',
