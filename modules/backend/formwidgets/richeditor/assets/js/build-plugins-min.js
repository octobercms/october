...
froalaOptions.htmlAllowedEmptyTags=this.options.allowEmptyTags?this.options.allowEmptyTags.split(/[\s,]+/):['textarea','a','iframe','object','video','style','script','i']
froalaOptions.htmlRemoveTags=['base']
