...
return [
    ...
    'branding' => [
        ...
        'app_name' => 'Dastur nomi',
        'app_name_description' => 'Это имя отображается в заголовке панели управления',
        'app_tagline' => 'Dastur shiori',
        'app_tagline_description' => 'Слоган будет отображаться на экране входа в панель управления.',
        'colors' => 'Ranglar',
        'primary_color' => 'Asosiy color',
        'secondary_color' => 'Ikkinchi color',
        'accent_color' => 'Цвет акцента',
        'styles' => 'Stillar',
        'custom_stylesheet' => 'Foydalanuvchi stillari',
        'navigation' => 'Navigatsiya',
        'menu_mode' => 'Menyu stili',
        'menu_mode_inline' => 'Qatorli rejim',
        'menu_mode_tile' => 'Katakli rejim',
        'menu_mode_collapsed' => 'Ixchamlashtirilgan rejim'
    ],
    'backend_preferences' => [
    ...
    'access_log' => [
        ...
        'menu_label' => 'Foydalanish jurnali',
    ...
    'import_export' => [
        'upload_csv_file' => '1. CSV-faylni yuklash',
        ...
        'show_ignored_columns' => 'Utqazib yuborilgan qatorlarni korsatish',
        'auto_match_columns' => 'Авто применение столбцов',
        'created' => 'Yaratildi',
        'updated' => 'Yangilandi',
        'skipped' => 'Utqazib yuborilgan',
        'warnings' => 'Ogohlantirish',
        'errors' => 'Xatoliklar',
        'skipped_rows' => 'Utqazib yuborilgan qatorlar',
        'import_progress' => 'Прогресс импорта',
        'processing' => 'Ishlov berish',
        'import_error' => 'Importdagi xatolik',
        ...
        'encoding_format' => 'Fayl kodlash turi',
        'encodings' => [
            'utf_8' => 'UTF-8',
            'us_ascii' => 'US-ASCII',
    ...
    'media' => [
        ...
        'move_empty' => "Ko'chirish uchun elementlarni tanlang.",
