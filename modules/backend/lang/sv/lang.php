...
return [
    ...
    'dashboard' => [
        ...
        'widget_columns_description' => 'Bredden på widget ska vara ett nummer mellan 1 och 10.',
        'widget_columns_error' => 'Vänligen ange widget bredden som ett nummer mellan 1 och 10.',
        'columns' => '{1} column|[2,Inf] kolonner',
        'widget_new_row_label' => 'Forcera en ny rad',
        'widget_new_row_description' => 'Lägg widget på en ny rad.',
        'widget_title_label' => 'Widget titel',
        'widget_title_error' => 'En widget titel är tvingande.',
        'status' => [
