...
return [
    ...
    'import_export' => [
        ...
        'processing_successful_line2' => 'مرورگر به صورت خودکار به آدرس دانلود فایل هدایت خواهد شد. ',
    ...
    'media' => [
        ...
        'empty_library' => 'اینجا یکم خالی به نظر می رسد. برای شروع فایل هایتان را بارگذاری کنید یا پوشه ای بسازید.',
        'insert' => 'قرار دادن',
