<?php return [
  ...
  'form' => [
    ...
    'not_found' => 'Form untuk data dengan ID :id tidak ditemukan.',
  ...
  'relation' => [
    ...
    'link' => 'Tautan',
    'link_name' => 'Tautan :name',
    'unlink' => 'Buka Tautan',
    'unlink_name' => 'Buka Tautan :name',
    'unlink_confirm' => 'Apakah Anda yakin?',
  ],
  'model' => [
    'name' => 'Model',
  ...
  'branding' => [
    ...
    'brand' => 'Brand',
    'logo' => 'Logo',
    'logo_description' => 'Unggah kustomisasi logo untuk digunakan pada back-end.',
    'app_name' => 'Nama Apl',
    'app_name_description' => 'Nama ini ditampilkan pada area judul back-end.',
    'app_tagline' => 'Tagline Aplikasi',
    'app_tagline_description' => 'Tagline ini akan ditampilkan pada layar masuk back-end.',
    'colors' => 'Warna',
    'primary_color' => 'Warna Primer',
    'secondary_color' => 'Warna Sekunder',
    'accent_color' => 'Warna Aksen',
    'styles' => 'Gaya',
    'custom_stylesheet' => 'Kustomisasi Stylesheet',
  ],
  'backend_preferences' => [
    'menu_label' => 'Penyesuaian Back-end',
