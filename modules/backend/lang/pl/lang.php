...
return [
    'auth' => [
        ...
        'invalid_login' => 'Podane przez Ciebie dane nie pasują do żadnego wpisu w naszej bazie danych. Sprawdź i spróbuj ponownie.'
    ],
    'field' => [
        'invalid_type' => 'Użyto nieprawidłowego typu pola :type.',
        'options_method_invalid_model' => "Atrybut ':field' nie jest prawidłowym modelem. Spróbuj podać metodę opcji dla klasy modelu :model bezpośrednio.",
        'options_method_not_exists' => "Model :model musi definiować metodę :method() zwracając opcję z pola ':field' formularza.",
        'colors_method_not_exists' => "Model :model musi definiować metodę :method() zwracającą kolor w formacie HEX dla pola formularza ':field'."
    ],
    'widget' => [
    ...
    'page' => [
        ...
        '404' => [
            ...
            'description' => 'Szukaliśmy, ale żądanego adresu URL po prostu nie można znaleźć. Może szukałeś czegoś innego?',
            'back_link' => 'Wróć do poprzedniej strony'
        ],
        'access_denied' => [
        ...
        'no_database'   => [
            ...
            'help'     => 'Baza danych jest wymagana do dostępu do panelu administracyjnego. Sprawdź czy baza danych jest prawidłowo skonfigurowana i zmigrowana przed ponowną próbą.',
            'cms_link' => 'Powrót do strony głównej',
        ],
        'invalid_token' => [
            'label' => 'Nieprawidłowy token bezpieczeństwa',
        ],
    ],
    'partial' => [
        'not_found_name' => "Fragment ':name' nie został odnaleziony.",
    ...
    'account' => [
        'impersonate' => 'Podszyj się pod użytkownika',
        'impersonate_confirm' => 'Czy na pewno chcesz podszyć się pod tego użytkownika? Możesz powrócić do pierwotnego stanu poprzez wylogowanie.',
        'impersonate_success' => 'Podszywasz się teraz pod tego użytkownika',
        'impersonate_working' => 'Podszywanie się...',
        'impersonating' => 'Podszywanie się pod użytkownika :full_name',
    ...
    'dashboard' => [
        ...
        'columns' => '{1} kolumna|[2,4] kolumny|[5, Inf] kolumn',
        ...
        'status' => [
            ...
            'update_available' => '{0} dostępnych aktualizacji!|{1} dostępna aktualizacja!|[2,4] dostępne aktualizacje!|[5, Inf] dostępnych aktualizacji!',
    ...
    'user' => [
        ...
        'email' => 'E-mail',
        'role_field' => 'Rola',
        'role_comment' => 'Rola określa uprawnienia użytkownika, które mogą być nadpisane na poziomie użytkownika, w zakładce Uprawnienia.',
        'groups' => 'Grupa',
        ...
        'return' => 'Wróć do listy administratorów',
        'allow' => 'Zezwól',
        'inherit' => 'Dziedzicz',
        'deny' => 'Odmów',
        ...
        'trashed_hint_desc' => 'To konto zostało usunięte i nie można się do niego zalogować. Aby je przywrócić, kliknij ikonę przywracania użytkownika w prawym dolnym rogu.'
    ],
    'list' => [
        'default_title' => 'Lista',
        ...
        'invalid_column_datetime' => "Wartość kolumny ':column' nie jest obiektem typu DateTime, czy nie brakuje Ci referencji \$dates w Modelu?",
        ...
        'setup_help' => 'Użyj pól wyboru, aby wybrać kolumny, które chcesz zobaczyć w liście. Możesz zmienić pozycję kolumny przeciągając ją w dół lub w górę.',
        'records_per_page' => 'Rekordy na stronę',
        'records_per_page_help' => 'Wybierz liczbę rekordów do wyświetlenia na stronę. Wyższa liczba rekordów na jedną stronę może zmniejszyć wydajność.',
        'check' => 'Sprawdź',
    ...
    'repeater' => [
        'min_items_failed' => ':name wymaga przynajmniej :min elementów. Tylko :items elementów zostało wprowadzonych',
        'max_items_failed' => ':name zezwala na maksymalnie :max elementów. Aż :items elementów zostało wprowadzonych'
    ],
    'form' => [
        ...
        'missing_model' => 'Zachowanie formularza w klasie :class nie ma zdefiniowanego Modelu.',
        ...
        'restore_confirm' => 'Czy na pewno chcesz przywrócić ten rekord?',
        ...
        'preview_no_media_message' => 'Brak zaznaczonych mediów.',
    ...
    'recordfinder' => [
        ...
        'invalid_model_class' => "Model ':modelClass' jest nieprawidłowy dla wyszukiwarki.",
        'cancel' => 'Anuluj'
    ],
    'pagelist' => [
    ...
    'reorder' => [
        ...
        'no_records' => 'Brak dostępnych rekordów do zmiany kolejności.',
    ],
    'model' => [
        'name' => 'Model',
    ...
    'warnings' => [
        ...
        'tips_description' => 'Istnieją pewne problemy, na które należy zwrócić uwagę, aby skonfigurować system poprawnie.',
        ...
        'plugin_missing' => 'Wtyczka :plugin jest wymagana, ale nie zainstalowana. Zainstaluj tą wtyczkę.'
    ],
    'editor' => [
        'menu_label'  => 'Ustawienia edytora kodu',
        'menu_description'  => 'Personalizuj ustawienia edytora kodu, takie jak wielkość czcionki oraz kolorystyka.',
        ...
        'line_breaker_tags' => 'Znaczniki złamania linii',
        'line_breaker_tags_comment' => 'Lista znaczników, które wstawią element złamania linii pomiędzy te znaczniki.',
    ...
    'myaccount' => [
        ...
        'menu_keywords' => 'bezpieczny login',
    ],
    'branding' => [
        ...
        'favicon' => 'Favicon',
        'favicon_description' => 'Wyślij własny favicon do użycia w panelu administracyjnym.',
    ...
    'filter' => [
        'all' => 'wszystkie',
        'options_method_not_exists' => "Model :model musi definiować metodę :method() zwracającą listę opcji dla filtru ':filter'.",
        'date_all' => 'Cały okres',
        'all_numbers' => 'Wszystkie numery'
    ],
    'import_export' => [
    ...
    'mediafinder' => [
        'label' => 'Wyszukiwarka mediów',
        'default_prompt' => 'Kliknij przycisk %s aby znaleźć element',
        'no_image' => 'Nie można znaleźć obrazu'
    ],
    'media' => [
        'menu_label' => 'Media',
        'upload' => 'Prześlij',
