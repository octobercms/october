...
return [
    ...
    'dashboard'           => [
        ...
        'manage_widgets'               => 'Upravljanje z vtičniki',
        'add_widget'                   => 'Dodaj vtičnik',
        'widget_inspector_title'       => 'Nastavitve vtičnika',
        'widget_inspector_description' => 'Nastavitve vtičnika za poročila',
        ...
        'status'                       => [
            ...
            'updates_pending'      => 'Posodobitev programske opreme je v teku',
            'updates_nil'          => 'Programska oprema je posodobljena',
            'updates_link'         => 'Posodobi',
            'warnings_pending'     => 'Nekatere težave potrebujejo pozornost',
    ...
    'user'                => [
        ...
        'group'                 => [
            ...
            'is_new_user_default_field_comment' => 'Nove administratorje vedno dodaj v to skupino',
            'code_field'                        => 'Koda',
    ...
    'list'                => [
        ...
        'no_records'                => 'V tem pogledu ni nobenih zapisov.',
        ...
        'loading'                   => 'Nalaganje...',
        'setup_title'               => 'Nastavitev seznama',
        'setup_help'                => 'Uporabite potrditvena polja (kvadratke) in izberite stolpce, ki jih želite prikazati na seznamu. Položaj stolpcev lahko spremenite tako, da jih povlečete gor ali dol.',
        'records_per_page'          => 'Število zapisov na strani',
        'records_per_page_help'     => 'Izberite koliko zapisov želite prikazati na eni strani. Upoštevajte, da lahko veliko število zapisov na eni strani zmanjša hitrost delovanja.',
        'check'                     => 'Označi',
    ...
    'form'                => [
        'create_title'                         => 'Ustvari :name',
        'update_title'                         => 'Uredi :name',
        'preview_title'                        => 'Predogled :name',
        'create_success'                       => ':name ustvarjen',
        'update_success'                       => ':name posodobljen',
        'delete_success'                       => ':name izbrisan',
        'restore_success'                      => ':name obnovljen',
    ...
    'warnings'            => [
        'tips'                   => 'Nasveti za nastavitve sistema',
    ...
    'editor'              => [
        ...
        'menu_description'           => 'Prilagodite splošne nastavitve urejevalnika, kot sta npr. velikost pisave in barvna shema.',
    ...
    'tooltips'            => [
        'preview_website' => 'Predogled spletne strani',
    ],
    'mysettings'          => [
    ...
    'branding'            => [
        ...
        'menu_description'          => 'Prilagodite okolje administracije, kot so ime, barve in logo.',
        'brand'                     => 'Blagovna znamka',
        'logo'                      => 'Logo',
        'logo_description'          => 'Naložite poljuben logotip, ki ga želite uporabiti v administraciji.',
        'favicon'                   => 'Ikona zaznamka',
        'favicon_description'       => 'Naložite poljubno ikono zaznamka za uporabo v administraciji.',
        ...
        'styles'                    => 'Slogi',
        'custom_stylesheet'         => 'Slogi po meri',
    ...
    'backend_preferences' => [
        ...
        'timezone_comment' => 'Prilagodi prikazane datume glede na izbran časovni pas.',
        'locale'           => 'Jezik',
        'locale_comment'   => 'Izberite želeni jezik za uporabo.',
    ],
    'access_log'          => [
        'hint'             => 'Ta dnevnik beleži seznam uspešnih prijav administratorjev. Zapisi se hranijo :days dni.',
        'menu_label'       => 'Dnevnik dostopa',
        'menu_description' => 'Oglejte si seznam uspešnih prijav administratorjev.',
        'id'               => 'ID',
    ...
    'media'               => [
        ...
        'folder'                     => 'Mapa',
        'no_files_found'             => 'Ni najdenih datotek, glede na vašo zahtevo.',
