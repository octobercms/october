...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => '是否禁用搜索引擎對該頁面編制索引？',
        'meta_robots_noindex_comment' => '普通用戶將訪問已被搜索引擎隱藏的頁面。',
        'meta_robots_nofollow' => '是否禁用搜索引擎跟隨此頁面上的鏈接？',
        'meta_robots_noarchive' => '是否提供搜索引擎頁面歸檔？',
        'markup' => '标记',
        'code' => '代码',
        'content' => '内容',
        'hidden' => '隐藏',
