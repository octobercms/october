...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Inaktivera sökmotorerna för att indexera den här sidan?',
        'meta_robots_noindex_comment' => "Vanliga användare kommer att besöka den sida som har gömts från sökmotorerna.",
        'meta_robots_nofollow' => 'Inaktivera sökmotorerna följ länkarna på den här sidan?',
        'meta_robots_noarchive' => 'Tillhandahålla en arkivering av en sökmotorsida?',
        'markup' => 'Markup',
        'code' => 'Kod',
        'content' => 'Innehåll',
        'hidden' => 'Dold',
