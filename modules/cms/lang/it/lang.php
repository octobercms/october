...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Disabilitare i motori di ricerca per indicizzare questa pagina?',
        'meta_robots_noindex_comment' => 'Gli utenti regolari visiteranno la pagina che è stata nascosta dai motori di ricerca.',
        'meta_robots_nofollow' => 'Disabilitare i motori di ricerca seguire i link in questa pagina?',
        'meta_robots_noarchive' => 'Fornire un archivio delle pagine dei motori di ricerca?',
        'markup' => 'Markup',
        'code' => 'Codice',
        'content' => 'Contenuto',
        'hidden' => 'Nascosto',
