...
return [
    ...
    'theme' => [
        ...
        'code_label' => 'Kód',
        'code_placeholder' => 'Egyedi azonosító a ehhez a témához',
        'dir_name_label' => 'Mappa',
        'dir_name_create_label' => 'A cél mappa',
        'theme_label' => 'Téma',
        ...
        'import_folders_label' => 'Mappák',
        'import_folders_comment' => 'Válassza ki a téma mappáit, amiket importálni szeretne',
        'export_button' => 'Exportálás',
        'export_title' => 'Téma exportálása',
        'export_folders_label' => 'Mappák',
        'export_folders_comment' => 'Válassza ki a téma mappáit, amiket exportálni szeretne',
        'delete_button' => 'Törlés',
        'delete_confirm' => 'Biztos, hogy törölni szeretné a témát? It cannot be undone!',
        'delete_active_theme_failed' => 'Nem lehet törölni az aktív témát. Először aktiváljon egy másik témát.',
        ...
        'new_directory_name_comment' => 'Adjon meg egy új mappát a duplikált témának.',
        'dir_name_invalid' => 'A név csak számokat, latin betűket és a következő szimbólumokat tartalmazhatja: _-',
        'dir_name_taken' => 'A megadott mappa név már létezik.',
    ...
    'media' => [
        ...
        'return_to_parent' => 'Vissza a szülő mappához',
        ...
        'new_folder_title' => 'Új mappa',
        'folder_name' => 'Mappa neve',
        'error_creating_folder' => 'Hiba a mappa létrehozásánál',
        'folder_or_file_exist' => 'Már létezik ilyen nevű fájl vagy mappa.',
        'move_empty' => 'Kérjük, válasszon ki fájlt az áthelyezéshez.',
        'move_popup_title' => 'Fájlok vagy mappák áthelyezése',
        'move_destination' => 'Cél mappa',
        'please_select_move_dest' => 'Kérjük, válasszon cél mappát.',
        'move_dest_src_match' => 'Kérjük, válasszon másik cél mappát.',
        'empty_library' => 'Kezdésként hozzon létre mappákat és töltsön fel fájlokat.',
        'insert' => 'Beillesztés',
