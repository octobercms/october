...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Désactiver les moteurs de recherche pour indexer cette page?',
        'meta_robots_noindex_comment' => 'Les utilisateurs réguliers visiteront la page qui a été masquée par les moteurs de recherche.',
        'meta_robots_nofollow' => 'Désactiver les moteurs de recherche suivez les liens sur cette page?',
        'meta_robots_noarchive' => 'Fournir un archivage de pages de moteurs de recherche?',
        'markup' => 'Balisage',
        'code' => 'Code',
        'content' => 'Contenu',
        'hidden' => 'Caché',
