...
return [
    ...
    'asset' => [
        ...
        'upload_files' => 'Dépot de fichier(s)',
        ...
        'error_uploading_file' => 'Erreur lors du dépot du fichier ":name" : :error',
    ...
    'media' => [
        ...
        'uploading_file_num' => 'Dépot de :number fichier(s)…',
        'uploading_complete' => 'Dépot de fichier(s) terminé',
        'order_by' => 'Trier par',
        'folder' => 'Répertoire',
