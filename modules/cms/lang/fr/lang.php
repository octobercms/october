...
return [
    ...
    'editor' => [
        ...
        'commit' => 'Commettre',
        'reset' => 'Réinitialiser',
        'commit_confirm' => 'Êtes-vous sûr de vouloir enregistrer vos modifications dans ce fichier dans le système de fichiers? Cela écrasera le fichier existant sur le système de fichiers.',
        'reset_confirm' => 'Êtes-vous sûr de vouloir réinitialiser ce fichier à partir de la copie qui se trouve sur le système de fichiers? Cela le remplacera complètement par le fichier qui se trouve sur le système de fichiers.',
        'committing' => 'Sauvegarde en cours',
        'resetting' => 'Réinitialisation en cours',
        'commit_success' => 'Le :type a été commis sur le système de fichiers',
        'reset_success' => 'Le :type a été réinitialisé à la version du système de fichiers',
    ],
    'asset' => [
        'menu_label' => 'Assets',
    ...
    'permissions' => [
        ...
        'manage_theme_options' => 'Configurer les options de personnalisation pour le thème actif',
    ],
    'theme_log' => [
        'hint' => "Ce journal affiche toutes les modifications apportées au thème par les administrateurs dans l'interface d'administration",
        'menu_label' => 'Journal des thèmes',
        'menu_description' => 'Afficher les modifications apportées au thème actif.',
        'empty_link' => 'Vider le journal des thèmes',
        'empty_loading' => 'Vidage du journal des thèmes...',
        'empty_success' => 'Le journal des thèmes à été vider',
        'return_link' => 'Retour au journal des thèmes',
        'id' => 'ID',
        ...
        'old_template' => 'Modèle (vieux)',
        'new_template' => 'Modèle (nouveau)',
        'template' => 'Modèle',
        'diff' => 'Changements',
        'old_value' => 'Ancienne valeur',
        'new_value' => 'Nouvelle valeur',
        'preview_title' => 'Changements de modèle',
