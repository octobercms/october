...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'このページのインデックスを作成する検索エンジンを無効にしますか？',
        'meta_robots_noindex_comment' => '通常のユーザーは、検索エンジンで非表示になっているページにアクセスします。',
        'meta_robots_nofollow' => '検索エンジンがこのページのリンクをたどらないようにしますか？',
        'meta_robots_noarchive' => '検索エンジンページのアーカイブを提供しますか？',
        'markup' => 'マークアップ',
        'code' => 'コード',
        'content' => 'コンテンツ',
        'hidden' => '非表示',
