...
return [
    ...
    'editor' => [
        ...
        'meta_robots_index' => 'Prevent search engines from indexing this page?',
        'meta_robots_index_comment' => 'Regular users will still be able to visit a page hidden from search engines.',
        'meta_robots_follow' => 'Prevent search engines from following the links on this page?',
        'meta_robots_archive' => 'Prevent search engines from archiving the page?',
        'markup' => 'Markup',
        'code' => 'Code',
        'content' => 'Content',
        'hidden' => 'Hidden',
