...
return [
    ...
    'editor' => [
        ...
        'meta_robots_index' => 'Запретить поисковым системам индексировать эту страницу?',
        'meta_robots_index_comment' => 'Обычные пользователи по-прежнему смогут посещать страницы, скрытые от поисковых систем.',
        'meta_robots_follow' => 'Запретить поисковым системам следовать по ссылкам на этой странице?',
        'meta_robots_archive' => 'Запретить поисковым системам архивировать эту страницу?',
        'markup' => 'Разметка',
        'code' => 'Код',
        'content' => 'Содержание',
