...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Вимкнути пошукові системи для індексації цієї сторінки?',
        'meta_robots_noindex_comment' => 'Регулярні користувачі відвідують сторінку, приховану від пошукових систем.',
        'meta_robots_nofollow' => 'Вимкнути пошукові системи за посиланнями на цій сторінці?',
        'meta_robots_noarchive' => 'Надати архівування сторінки пошукової системи?',
        'markup' => 'Шаблон',
        'code' => 'Код',
        'content' => 'Зміст',
