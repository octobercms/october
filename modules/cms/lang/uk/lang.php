...
return [
    ...
    'theme' => [
        ...
        'new_directory_name_comment' => 'Вкажіть нове ім\'я каталогу дубліката теми.',
    ...
    'maintenance' => [
        ...
        'settings_menu_description' => 'Управління режимом роботи сайту.',
    ...
    'mediafinder' => [
        'label' => 'Media Finder',
        'default_prompt' => 'Натисніть на кнопку %s, щоб знайти мультимедійний',
    ],
    'media' => [
        ...
        'size' => 'Розміром',
        'title' => 'Ім\'ям',
        'last_modified' => 'Останньою зміною',
