...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Deaktiver søkemotorene for å indeksere denne siden?',
        'meta_robots_noindex_comment' => 'Vanlige brukere vil besøke siden som er skjult for søkemotorene.',
        'meta_robots_nofollow' => 'Deaktiver søkemotorene etter koblingene på denne siden?',
        'meta_robots_noarchive' => 'Vil du arkivere en søkemotorside?',
        'markup' => 'Markup',
        'code' => 'Kode',
        'content' => 'Innhold',
        'hidden' => 'Skjult',
