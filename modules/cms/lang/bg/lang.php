...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Деактивиране на търсачките да индексират тази страница?',
        'meta_robots_noindex_comment' => 'Редовните потребители ще посещават страницата, която е била скрита от търсачките.',
        'meta_robots_nofollow' => 'Деактивиране на търсачките да следват връзките на тази страница?',
        'meta_robots_noarchive' => 'Предоставяне на архивиране на страницата на търсачката?',
        'markup' => 'Markup',
        'code' => 'Код',
        'content' => 'Съдържание',
        'hidden' => 'Скрит',
