...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'موتورهای جستجو را غیرفعال کنید تا این صفحه را فهرست بندی کنند؟',
        'meta_robots_noindex_comment' => 'کاربران عادی از صفحهای مخفی شده از موتورهای جستجو بازدید می کنند.',
        'meta_robots_nofollow' => 'غیرفعال کردن موتورهای جستجو پیوندهای این صفحه را دنبال می کنند؟',
        'meta_robots_noarchive' => 'بایگانی صفحه موتور جستجو را ارائه دهید؟',
        'markup' => 'نشانه گذاری',
        'code' => 'کد',
        'content' => 'محتوی',
        'hidden' => 'مخفی',
