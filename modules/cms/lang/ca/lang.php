...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Desactivar els motors de cerca per indexar aquesta pàgina?',
        'meta_robots_noindex_comment' => 'Els usuaris habituals visitaran la pàgina que s\'ha amagat als motors de cerca.',
        'meta_robots_nofollow' => 'Desactivar els motors de cerca seguint els enllaços d\'aquesta pàgina?',
        'meta_robots_noarchive' => 'Proporcionar un arxiu de pàgines del motor de cerca?',
        'markup' => 'Marcat',
        'code' => 'Codi',
        'content' => 'Contingut',
        'hidden' => 'Amagat',
