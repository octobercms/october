...
return [
    'cms_object' => [
        ...
        'error_saving' => "Error guardant l'arxiu ':name'. Siusplau revisa els permisos d'escriptura.",
        'error_creating_directory' => "Error creant el directori ':name'. Siusplau revisa els permisos d'escriptura.",
        'invalid_file_extension' => "Extensió d'arxiu invàlida: :invalid. Extensions permeses: :allowed.",
        'error_deleting' => "Error eliminant l'arxiu de plantilla ':name'. Siusplau revisa els permisos d'escriptura.",
    ...
    'theme' => [
        ...
        'edit' => [
            ...
            'not_match' => "L'objecte al que estàs intentant accedir no pertany al tema que estàs editant. Siusplau recarrega la pàgina."
        ],
        ...
        'import_folders_comment' => 'Siusplau sel·lecciona les carpetes del tema que vols importar',
        'export_button' => 'Exportar',
        'export_title' => 'Exportar tema',
        'export_folders_label' => 'Carpetes',
        'export_folders_comment' => 'Siusplau sel·lecciona les carpetes del tema que vols exportar',
        'delete_button' => 'Eliminar',
        'delete_confirm' => 'Eliminar aquest tema? No es pot desfer!',
        'delete_active_theme_failed' => 'No es pot borrar el tema actiu, estableix un altre tema com a actiu primer.',
        ...
        'create_theme_required_name' => 'Siusplau indica un nom pel nou tema.',
    ...
    'maintenance' => [
        ...
        'is_enabled_comment' => 'Sel·lecciona la pàgina per mostrar quan el mode de manteniment està activat.',
    ...
    'page' => [
        ...
        'delete_confirm_multiple' => 'Eliminar pàgines sel·leccionades?',
    ...
    'layout' => [
        ...
        'new' => 'Nova plantilla',
        'delete_confirm_multiple' => 'Eliminar plantilles sel·leccionades?',
    ...
    'partial' => [
        ...
        'delete_confirm_multiple' => 'Eliminar parcials sel·leccionats?',
    ...
    'content' => [
        ...
        'delete_confirm_multiple' => 'Eliminar arxius o directoris de contingut sel·leccionats?',
        'delete_confirm_single' => 'Eliminar aquest arxiu de contingut?',
        'new' => 'Nou arxiu de contingut'
    ],
    'ajax_handler' => [
        'invalid_name' => "Nom de handler d'AJAX invàlid: :name.",
        'not_found' => "El handler AJAX ':name' no s'ha trobat."
    ],
    'cms' => [
        'menu_label' => 'CMS'
    ],
    ...
    'editor' => [
        ...
        'content' => 'Contingut',
        'hidden' => 'Amagat',
        'hidden_comment' => "Les pàgines amagades només són accessibles pels usuaris logats a l'àrea d'administració.",
    ...
    'asset' => [
        'menu_label' => 'Assets',
        'unsaved_label' => 'Assets no guardats',
        ...
        'error_renaming' => "Error renombrant l'arxiu o directori",
        'name_cant_be_empty' => 'El nom no pot estar buit',
        'too_large' => "L'arxiu pujat és massa gran. El tamany màxim d'arxiu és :max_size",
        ...
        'move_please_select' => 'siusplau sel·lecciona',
        'move_destination' => 'Directori de destí',
        'move_popup_title' => 'Moure assets',
        'move_button' => 'Moure',
        'selected_files_not_found' => "No s'han trobat els arxius sel·leccionats",
        'select_destination_dir' => 'Siusplau sel·lecciona un directori de destí',
        ...
        'delete_confirm' => 'Eliminar els arxius o directoris sel·leccionats?',
        'path' => 'Ruta'
    ],
    'component' => [
    ...
    'template' => [
        ...
        'delete_confirm' => 'Eliminar les plantilles sel·leccionades?',
        'order_by' => 'Ordenar per'
    ],
    'permissions' => [
        'name' => 'CMS',
        'manage_content' => 'Gestionar els arxius de contingut del lloc web',
        'manage_assets' => 'Gestionar els assets del lloc web - imatges, arxius JavaScript, arxius CSS',
    ...
    'theme_log' => [
        'hint' => "Aquest registre mostra els canvis fets al tema desde l'àrea d'administració.",
