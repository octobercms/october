...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Адключыць пошукавыя сістэмы для індэксавання гэтай старонкі?',
        'meta_robots_noindex_comment' => 'Сталыя карыстальнікі будуць наведваць старонку, якую схавалі ад пошукавых сістэм.',
        'meta_robots_nofollow' => 'Адключыць пошукавыя сістэмы пераходзіць па спасылках на гэтай старонцы?',
        'meta_robots_noarchive' => 'Забяспечыць архіваванне старонкі пошукавай сістэмы?',
        'markup' => "Макет",
        'code' => "Код",
        'content' => "Змест",
        'hidden' => "Схаваная",
