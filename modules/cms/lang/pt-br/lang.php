...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Desativar os mecanismos de pesquisa para indexar esta página?',
        'meta_robots_noindex_comment' => 'Usuários regulares visitarão a página que foi ocultada pelos mecanismos de pesquisa.',
        'meta_robots_nofollow' => 'Desativar os motores de busca seguem os links nesta página?',
        'meta_robots_noarchive' => 'Fornecer um arquivamento de página do mecanismo de pesquisa?',
        'markup' => 'Edição',
        'code' => 'Código',
        'content' => 'Conteúdo',
        'hidden' => 'Oculta',
