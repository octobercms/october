<?php return [
  ...
  'theme' => [
    ...
    'author_code_label' => 'Código do autor',
    'author_code_placeholder' => 'Um código exclusivo para o autor usado para distribuição',
    'code_label' => 'Código',
    'code_placeholder' => 'Um código exclusivo para esse tema a ser usado para distribuição',
    'parent_label' => 'Tema pai',
    'no_parent' => '-- nenhum pai --',
    'database_templates_label' => 'Modo de banco de dados',
    'database_templates_description' => 'Salve as alterações deste tema no banco de dados em vez nos arquivos',
