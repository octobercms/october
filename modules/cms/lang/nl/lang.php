...
return [
    ...
    'theme' => [
        ...
        'active_button' => 'Actief',
        'default_tab' => 'Eigenschappen',
        'name_label' => 'Naam',
        'name_create_placeholder' => 'Themanaam',
        'author_label' => 'Auteur',
        ...
        'import_overwrite_comment' => 'Vink deze optie uit om alleen nieuwe bestanden te importeren.',
    ...
    'component' => [
        ...
        'method_not_found' => 'Het component \':name\' bevat geen methode \':method\'.',
    ],
    'template' => [
    ...
    'mediafinder' => [
        'default_prompt' => 'Klik op de knop %s om een media-item te vinden'
    ],
    'media' => [
        ...
        'thumbnail_error' => 'Fout opgetreden bij het genereren van de miniatuurweergave.',
        ...
        'uploading_error' => 'Uploaden mislukt',
        'order_by' => 'Sorteer op',
        'folder' => 'Map',
        ...
        'move_empty' => 'Selecteer items om te verplaatsen.',
        ...
        'empty_library' => 'De mediabibliotheek is leeg. Upload bestanden of maak mappen aan om te beginnen.',
        'insert' => 'Invoegen',
