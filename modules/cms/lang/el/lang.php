...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Απενεργοποιήστε τις μηχανές αναζήτησης για την ευρετηρίαση αυτής της σελίδας',
        'meta_robots_noindex_comment' => 'Οι τακτικοί χρήστες θα επισκεφτούν τη σελίδα που έχει κρυφτεί από τις μηχανές αναζήτησης.',
        'meta_robots_nofollow' => 'Απενεργοποιήστε τις μηχανές αναζήτησης ακολουθώντας τους συνδέσμους σε αυτή τη σελίδα',
        'meta_robots_noarchive' => 'Παροχή αρχειοθέτησης σελίδας μηχανής αναζήτησης',
        'markup' => 'Markup',
        'code' => 'Κώδικας',
        'content' => 'Περιεχόμενο',
        'hidden' => 'Κρυφό',
