...
return [
    ...
    'mediafinder' => [
        'label' => 'Mediaetsin',
        'default_prompt' => 'Klikkaa %s painikkeesta etsiäksesi mediakohteita'
    ],
    'media' => [
        'invalid_path' => "Virheellinen tiedostopolku määritelty: ':path'.",
        'menu_label' => 'Media',
        'upload' => 'Lataa',
        'move' => 'Siirrä',
        'delete' => 'Poista',
        ...
        'library' => 'Kirjasto',
        'folder_size_items' => 'kohteet',
        'size' => 'Koko',
        'title' => 'Otsikko',
        'last_modified' => 'Viimeksi muokattu',
        'public_url' => 'Latausosoite',
        'click_here' => 'Napsauta tästä',
        'thumbnail_error' => 'Virhe tuottaessa pikkukuvaa.',
        'return_to_parent' => 'Palaa pääkansioon',
        'return_to_parent_label' => 'Mene ylös ..',
        'nothing_selected' => 'Mitään ei ole valittuna.',
        'multiple_selected' => 'Useita kohteina valittuna.',
        'uploading_file_num' => 'Ladataan :number tiedosto(a)...',
        'uploading_complete' => 'Lataus valmis',
        'uploading_error' => 'Lataus epäonnistui',
        'type_blocked' => 'Tiedostotyyppi on estetty tietoturvasyistä.',
        'order_by' => 'Suodata',
        'folder' => 'Kansio',
        'no_files_found' => 'Pyyntösi ei vastaa yhtään tiedostoa.',
        'delete_empty' => 'Valitse kohteet poistettavaksi.',
        'delete_confirm' => 'Poista valitut kohteet?',
        'error_renaming_file' => 'Virhe tiedoston uudelleennimeämisessä.',
        'new_folder_title' => 'Uusi kansio',
        'folder_name' => 'Kansion nimi',
        'error_creating_folder' => 'Virhe luotaessa kansiota',
        'folder_or_file_exist' => 'Kansio tai tiedosto määritellyllä nimellä on jo olemassa.',
        'move_empty' => 'Valitse kohteet siirrettäviksi.',
        ...
        'empty_library' => 'Täällä näyttää hieman tyhjältä. Päästäksesi alkuun, lataa tiedostoja tai luo kansiota.',
        'insert' => 'Liitä',
        'crop_and_insert' => 'Rajaa ja liitä',
        'select_single_image' => 'Valitse ykis kuva.',
        'selection_not_image' => 'Valittu kohde ei ole kuva.',
        'restore' => 'Kumoa kaikki muutokset',
        'resize' => 'Muuta kokoa...',
