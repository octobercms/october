...
return [
    ...
    'dashboard' => [
        'active_theme' => [
            ...
            'manage_themes' => 'Quản lý themes',
            'customize_theme' => 'Tùy chỉnh theme'
        ]
    ],
    'theme' => [
        'not_found_name' => "Theme ':name' không tồn tại",
        'by_author' => 'Tạo bởi :name',
        'active' => [
            'not_set' => 'Theme đang kích hoạt chưa được cài đặt.',
            'not_found' => 'Không tìm thấy theme đang kích hoạt.'
        ],
        'edit' => [
            'not_set' => 'Theme chưa được cài đặt.',
            'not_found' => 'Không tìm thấy theme.',
            'not_match' => "Theme này đang trong chế độ chỉnh sửa. Vui lòng tải lại trang"
        ],
        'settings_menu' => 'Giao diện front-end',
        'settings_menu_description' => 'Quản lý  giao diện front-end và các tùy chỉnh',
        'default_tab' => 'Các thuộc tính',
        'name_label' => 'Tên',
        'name_create_placeholder' => 'Tên theme',
        'author_label' => 'Tác giả',
        'author_placeholder' => 'Tên cá nhân hoặc công ty',
        'description_label' => 'Mô tả',
        'description_placeholder' => 'Mô tả theme',
        'homepage_label' => 'Trang chủ',
        'homepage_placeholder' => 'Đường dẫn trang chủ tác giả',
        'code_label' => 'Code',
        'code_placeholder' => 'Tạo mã code duy nhất để phân phối theme của bạn',
        'preview_image_label' => 'Hình ảnh xem trước theme',
        'preview_image_placeholder' => 'Đường dẫn hình ảnh xem trước của theme.',
