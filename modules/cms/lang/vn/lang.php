...
return [
    ...
    'editor' => [
        ...
        'meta_robots_noindex' => 'Vô hiệu hóa các công cụ tìm kiếm để lập chỉ mục trang này?',
        'meta_robots_noindex_comment' => 'Người dùng thông thường sẽ truy cập trang đã bị ẩn khỏi các công cụ tìm kiếm.',
        'meta_robots_nofollow' => 'Vô hiệu hóa các công cụ tìm kiếm theo liên kết trên trang này?',
        'meta_robots_noarchive' => 'Cung cấp lưu trữ trang công cụ tìm kiếm?',
        'markup' => 'Markup',
        'code' => 'Code',
        'content' => 'Nội dung',
        'hidden' => 'Ẩn',
