...
return [
    ...
    'theme' => [
        ...
        'active' => [
            ...
            'not_found' => 'Không tìm thấy theme đang kích hoạt.'
        ],
        'edit' => [
    ...
    'content' => [
        'not_found_name' => "Không tìm thấy tệp tin content ':name'.",
        'menu_label' => 'Content',
        'unsaved_label' => 'Chưa lưu content',
        'no_list_records' => 'Không tìm thấy file content nào',
        'delete_confirm_multiple' => 'Xóa các file content hoặc đường dẫn đã chọn?',
        'delete_confirm_single' => 'Xóa file content này?',
        'new' => 'File content mới'
    ],
    'ajax_handler' => [
    ...
    'asset' => [
        ...
        'error_deleting_file' => 'Lỗi xóa file :name.',
        ...
        'original_not_found' => 'File gốc hoặc đường dẫn không tồn tại',
        'already_exists' => 'Tên file hoặc đường dẫn đã tồn tại',
        'error_renaming' => 'Lỗi sửa tên file hoặc thư mục',
        'name_cant_be_empty' => 'Tên không được để trống',
        'too_large' => 'Kích thước file quá lớn. Kích thước file không được vượt quá :max_size',
        'type_not_allowed' => 'Chỉ chấp nhận các loại file sau: :allowed_types',
        'file_not_valid' => 'File không hợp lệ',
        'error_uploading_file' => "Lỗi upload file ':name': :error",
    ...
    'permissions' => [
        'name' => 'CMS',
        'manage_content' => 'Quản lý các file content của website',
        'manage_assets' => 'Quản lý các thư mục và file assets - images, JavaScript files, CSS',
    ...
    'theme_log' => [
        'hint' => 'Bản ghi những thay đổi của theme được thực hiện trong trang quản trị',
        'menu_label' => 'Nhật ký theme',
        'menu_description' => 'Xem những thay đổi của giao diện đang được kích hoạt.',
        'empty_link' => 'Xóa hết nhật ký về thay đổi theme',
        'empty_loading' => 'Đang xóa nhật ký theme...',
        'empty_success' => 'Đã xóa hết nhật ký',
        'return_link' => 'Quay lại trang nhật ký theme',
        'id' => 'ID',
        'id_label' => 'Log ID',
        ...
        'old_template' => 'Template (Cũ)',
        'new_template' => 'Template (Mới)',
        'template' => 'Template',
        'diff' => 'Thay đổi',
        'old_value' => 'Giá trị cũ',
        'new_value' => 'Giá trị mới',
        'preview_title' => 'Thay đổi template',
        'template_updated' => 'Template đã được cập nhật',
        'template_created' => 'Template đã được tạo',
        'template_deleted' => 'Template đã xóa',
    ],
];
