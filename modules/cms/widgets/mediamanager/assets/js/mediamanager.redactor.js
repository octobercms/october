    ...
    return {
        ...
        onInsertLink: function(buttonName)
        {
            ...
            new $.oc.mediaManager.popup({
                ...
                onInsert: function(items) {
                    if (!items.length) {
                        sweetAlert($.oc.lang.get('mediamanager.invalid_file_empty_insert'))
                        return
                    }

                    if (items.length > 1) {
                        sweetAlert($.oc.lang.get('mediamanager.invalid_file_single_insert'))
                        return
                    }
        ...
        onInsertImage: function(buttonName)
        {
            ...
            new $.oc.mediaManager.popup({
                ...
                onInsert: function(items) {
                    if (!items.length) {
                        sweetAlert($.oc.lang.get('mediamanager.invalid_image_empty_insert'))
                        return
                    }
                    ...
                    for (var i=0, len=items.length; i<len; i++) {
                        if (items[i].documentType !== 'image') {
                            sweetAlert($.oc.lang.get('mediamanager.invalid_image_invalid_insert', 'The file "'+items[i].title+'" is not an image.'))
                            continue
                        }
        ...
        onInsertVideo: function(buttonName) {
            ...
            new $.oc.mediaManager.popup({
                ...
                onInsert: function(items) {
                    if (!items.length) {
                        sweetAlert($.oc.lang.get('mediamanager.invalid_video_empty_insert'))
                        return
                    }
                    ...
                    if (item.documentType !== 'video') {
                        sweetAlert($.oc.lang.get('mediamanager.invalid_video_invalid_insert', 'The file "'+item.title+'" is not a video.'))
                        return
                    }
        ...
        onInsertAudio: function(buttonName) {
            ...
            new $.oc.mediaManager.popup({
                ...
                onInsert: function(items) {
                    if (!items.length) {
                        sweetAlert($.oc.lang.get('mediamanager.invalid_audio_empty_insert'))
                        return
                    }
                    ...
                    if (item.documentType !== 'audio') {
                        sweetAlert($.oc.lang.get('mediamanager.invalid_audio_invalid_insert', 'The file "'+item.title+'" is not an audio file.'))
                        return
                    }
